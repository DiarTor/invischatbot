...
- DATABASE_URL or DB_PATH — path/URL for the database
...
You can also run `test.py` to execute quick tests or scripts included in the repo.
...
- `CD.todo`, `migration.log` — project notes / migration history
